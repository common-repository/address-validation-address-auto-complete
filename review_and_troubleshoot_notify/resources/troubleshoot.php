		...
		<div class="elex-banner-wrap">
			<div class="elex-banner-row">
				...
				<div class="elex-banner-row-content" id='elex-review-component'>
					<h5 style="font-size: 18px;margin-top:0;margin-bottom:10px;"><?php echo esc_html_e( __( 'Trouble setting up the Plugin?', 'address-validation-address-auto-complete' ) ); ?></h5>
					<p style="font-size:16px ; line-height: 1.5;margin-top:0;margin-bottom:10px;">
						<?php echo esc_html_e( __( 'Need help on setting up ', 'address-validation-address-auto-complete' ) . esc_attr( $this->data['name'] ) . __( ' plugin? You may go through our detailed documentation. For any further assistance, please don`t hesitate to reach out to our amazing support team.', 'address-validation-address-auto-complete' ) ); ?>
					</p>
					...
					<div class="elex-banner-button-wrap">
						...
						">
							...
							<?php echo esc_html_e( __( 'Never ask again', 'address-validation-address-auto-complete' ) ); ?>
						</a>
						<a class="button elex-btn-hover-light text-nowrap d-flex align-items-center gap-2" href="<?php echo esc_url( $this->data['documentation_url'] ); ?>" target="_blank">
							...
							<?php echo esc_html_e( __( 'Read Documentation', 'address-validation-address-auto-complete' ) ); ?>
						</a>
						<a class="button button-primary" href="<?php echo esc_url( $this->data['support_url'] ); ?>" target="_blank">
							...
							<?php echo esc_html_e( __( 'Contact Support', 'address-validation-address-auto-complete' ) ); ?>
						</a>
					</div>
				</div>
				<?php
