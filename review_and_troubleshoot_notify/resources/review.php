		...
		<div class="elex-banner-wrap">
			<div class="elex-banner-row">
				<div class="elex-banner-row-content">
					<h2 style="font-size: 18px;margin-top:0;margin-bottom:10px;"><?php echo esc_html_e( __( 'Leave Us a Review', 'address-validation-address-auto-complete' ) ); ?></h2>
					<p style="font-size:16px ; line-height: 1.5;margin-top:0;margin-bottom:10px;">
						<?php	echo esc_html_e( __( 'Hi there! You`ve been using ', 'address-validation-address-auto-complete' ) . esc_attr( $this->data['name'] ) . __( ' plugin for over 7 days now. Hope it helps you run your business smoothly. Please take a moment to rate us 5 star!', 'address-validation-address-auto-complete' ) ); ?>
					</p>
					...
					<div class="elex-banner-button-wrap">
						...
						">
							...
							<?php echo esc_html_e( __( 'I will do it later', 'address-validation-address-auto-complete' ) ); ?>
						</a>
						<a class="button button-primary " href="<?php echo esc_url( $this->data['rating_url'] ); ?>" target="_blank">
							...
							<?php echo esc_html_e( __( 'Sure! I`d love to rate', 'address-validation-address-auto-complete' ) ); ?>
						</a>
					</div>
				</div>
				<?php
